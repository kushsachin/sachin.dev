    ...
    >
      <div
        className={`absolute inset-0 ${
          isDark
            ? "opacity-[10%] bg-[radial-gradient(#D8FFC0_1px,transparent_1px)]"
      ...
      >
        <div className="text-center md:text-left">
          ...
          <motion.div
            ...
            className={`w-[35%] lg:w-[10%] h-1 mx-auto md:mx-0 mt-4 origin-center lg:origin-left ${
          ...
          {skills.map((skill, index) => (
            <motion.div
              ...
              className={`group relative p-3 rounded-lg border-2 ${
                isDark
                  ? "bg-[#2A271F]/30 border-[#B7C7F3]/60 hover:border-[#D8FFC0]/50"
                  : "bg-white/30 border-[#2A271F]/60 hover:border-[#B88E6A]/50"
